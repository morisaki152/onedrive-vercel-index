...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'datauser01@hhnwmct.onmicrosoft.com',
  ...
  title: "ZatLan's OneDrive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/PublicVercel',
  ...
  footer:
       'Powered by ZatLan Movies Website',
  ...
  protectedRoutes: ['/Private', '/Vercelp'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:zatlan.movie@gmail.com',
  ...
  links: [
    {
      ...
      // link: 'https://github.com/morisaki152/onedrive-vercel-index',
    },
  ],
